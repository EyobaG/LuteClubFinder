        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/discover" className="text-white hover:text-plu-gold transition-colors">
                  Browse Clubs
                </Link>
              </li>
              <li>
                <Link to="/quiz" className="text-white hover:text-plu-gold transition-colors">
                  Take the Quiz
                </Link>
              </li>
              <li>
                <Link to="/events" className="text-white hover:text-plu-gold transition-colors">
                  Events
                </Link>
              </li>
              <li>
                <Link to="/announcements" className="text-white hover:text-plu-gold transition-colors">
                  Announcements
                </Link>
              </li>
            </ul>
              ...
              {CATEGORIES.map((cat) => (
                <li key={cat.value}>
                  <Link
                    ...
                    className="text-white hover:text-plu-gold transition-colors"
                  >
                    {cat.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/profile" className="text-white hover:text-plu-gold transition-colors">
                  Profile
                </Link>
              </li>
              <li>
                <Link to="/saved" className="text-white hover:text-plu-gold transition-colors">
                  Saved Clubs
                </Link>
              </li>
              <li>
                <Link to="/leader" className="text-white hover:text-plu-gold transition-colors">
                  Club Leader Portal
                </Link>
              </li>
              <li>
