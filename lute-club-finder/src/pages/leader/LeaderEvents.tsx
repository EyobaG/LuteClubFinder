...
import { useLeaderEvents, useLeaderClubs } from '../../hooks/useLeader';
...
export default function LeaderEvents() {
  ...
  return (
    <div>
      ...
      {/* Filters */}
      <div className={`grid grid-cols-1 sm:grid-cols-2 ${clubOptions.length > 0 ? 'lg:grid-cols-4' : 'lg:grid-cols-3'} gap-3 mb-6`}>
        <Input
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12 bg-white rounded-xl border border-gray-200">
          ...
          <Link to="/leader/events/new" className="text-indigo-600 text-sm hover:underline mt-2 inline-block">
